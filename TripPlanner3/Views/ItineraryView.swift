...
//                    var yOffset: CGFloat = 30 // **Moved everything up slightly**
//
//                    // ✅ **First Page - Title for the Itinerary**
//                    context.beginPage()
//                    let titleAttributes: [NSAttributedString.Key: Any] = [
//                        .font: UIFont.boldSystemFont(ofSize: 28),
//                        .foregroundColor: UIColor.black
//                    ]
//                    let itineraryTitle = "Itinerary for \(location)"
//                    itineraryTitle.draw(in: CGRect(x: 20, y: yOffset, width: 572, height: 50), withAttributes: titleAttributes)
//                    yOffset += 50
//
//                    // ✅ **Loop through all days**
//                    for (index, dayActivity) in planController.locationActivitiesByDay.enumerated() {
//                        // Start a new page for every day **except** for Day 1 (which starts below the title)
//                        if index > 0 {
//                            context.beginPage()
//                            yOffset = 30 // **Moved up slightly**
//                        }
//
//                        // **Font Styling**
...
//                        dayTitle.draw(in: CGRect(x: 20, y: yOffset, width: 572, height: 30), withAttributes: dayTitleAttributes)
//                        yOffset += 30
//
//                        // ✅ **Add Day Summary (Italic)**
//                        dayActivity.summary.draw(in: CGRect(x: 20, y: yOffset, width: 572, height: 40), withAttributes: daySummaryAttributes)
//                        yOffset += 45 // **Moved up slightly**
//
//                        // ✅ **Loop through all locations for this day**
//                        for location in dayActivity.locations {
//                            // **Check if there's enough space; if not, start a new page**
//                            if yOffset + 220 > 750 {  // **Moved up slightly**
//                                context.beginPage()
//                                yOffset = 30 // **New page starts higher**
//                            }
//
//                            // ✅ **Location Name (Bold & Larger)**
//                            location.location.draw(in: CGRect(x: 20, y: yOffset, width: 572, height: 30), withAttributes: locationNameAttributes)
//                            yOffset += 25 // **Moved up slightly**
//
//                            // ✅ **Address (Italic & Dark Gray)**
//                            location.address.draw(in: CGRect(x: 20, y: yOffset, width: 572, height: 20), withAttributes: addressAttributes)
//                            yOffset += 25 // **Moved up slightly**
//
//                            // ✅ **Insert Image from Cache**
//                            if let imageUrl = location.imageUrl, let image = imageCache[imageUrl] {
//                                let imageRect = CGRect(x: 20, y: yOffset, width: 572, height: 180) // Full width
//                                image.draw(in: imageRect)
//                                yOffset += 185 // **Moved up slightly**
//                            } else {
//                                print("⚠️ Image not found in cache for: \(location.imageUrl ?? "Unknown Image")")
//                            }
//
//                            // ✅ **Location Description (Normal font)**
//                            location.description.draw(in: CGRect(x: 20, y: yOffset, width: 572, height: 60), withAttributes: descriptionAttributes)
//                            yOffset += 65 // **Moved up slightly**
//                        }
//                    }
//                }
//
